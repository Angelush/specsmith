...
**Video:** [https://www.youtube.com/watch?v=dQK_pTXrGDk](https://www.youtube.com/watch?v=dQK_pTXrGDk) • **ID:** `dQK_pTXrGDk` • **Playlists:** P1

## Concepts covered

- [[concepts/ai-infrastructure-evolution]] — Existing enterprise systems, like CRMs, are evolving into agent infrastructure, enabling direct agent interaction via APIs and CLI tools without human logins.
- [[concepts/model-selection-frameworks]] — Evaluate new agent launches using frameworks that consider layering and infrastructure, rather than just features, to determine genuine team-relevant value.
