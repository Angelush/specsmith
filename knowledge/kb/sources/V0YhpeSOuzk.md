...
**Video:** [https://www.youtube.com/watch?v=V0YhpeSOuzk](https://www.youtube.com/watch?v=V0YhpeSOuzk) • **ID:** `V0YhpeSOuzk` • **Playlists:** P0, P1, P2

## Concepts covered

- [[concepts/prompting-and-skill-design]] — A prompt lifecycle guide provides structure for systematic prompt development and skill enhancement.
