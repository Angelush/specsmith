...
# Your Boss says 'Use AI!'

**Video:** [https://www.youtube.com/watch?v=1FKxyPAJ2Ok](https://www.youtube.com/watch?v=1FKxyPAJ2Ok) • **ID:** `1FKxyPAJ2Ok` • **Playlists:** P0, P3

## Concepts covered

- [[concepts/model-selection-frameworks]] — Always pick the lowest technology rung that captures 90% of the value — costs and maintenance scale exponentially upward.
- [[concepts/ai-roi-and-value-proposition]] — Adopt AI only when it delivers 10x improvement over the simpler baseline — bad data always defeats model sophistication.
