...
**Video:** [https://www.youtube.com/watch?v=MFzxIT88zfg](https://www.youtube.com/watch?v=MFzxIT88zfg) • **ID:** `MFzxIT88zfg` • **Playlists:** P0, P2

## Concepts covered

- [[concepts/ai-quality-control]] — Office-doc work needs a four-stage pipeline (sources → structure/file-spec → constrained creation → verification) plus a task risk gradient; "polish stopped meaning trust" — a financial model can look validated but have wrong formulas with no REF error.
