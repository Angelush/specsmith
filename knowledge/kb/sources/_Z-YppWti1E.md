...
**Video:** [https://www.youtube.com/watch?v=_Z-YppWti1E](https://www.youtube.com/watch?v=_Z-YppWti1E) • **ID:** `_Z-YppWti1E` • **Playlists:** P0, P2, P3

## Concepts covered

- [[concepts/model-selection-frameworks]] — The video suggests a routing layer abstraction to match tasks to specific AI models based on workflow capabilities.
